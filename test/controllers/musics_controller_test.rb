...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { artist: @music.artist, genere: @music.genere, label: @music.label, rate: @music.rate, title: @music.title, year: @music.year }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { artist: @music.artist, genere: @music.genere, label: @music.label, rate: @music.rate, title: @music.title, year: @music.year }
    assert_redirected_to music_path(assigns(:music))
  end
